/*CODE: PB WITH EXTERNAL PULLDOWN RESISTOR AND BUTTON STATE PRINTED VIA SERIAL MONITOR

Description: This program reads the state of a pushbutton switch with an external pulldown resistor connected to digital pin 2 (PB),
...
The buttonState logic would be as is since pull down resistors does not affect the logic of the circuit. */ 
